...
db_root=downloads/wav # direcotry including spk name directory (MODIFY BY YOURSELF)
                          # e.g.
                          # /path/to/database
                          # ├── spk_1
                          # │   ├── utt1.wav
                          ...
                          #     ├── utt1.wav
                          #     ...
dumpdir=dump_original # directory to dump features
...
num_dev=35    # the number of development data for each speaker
num_eval=0   # the number of evaluation data for each speaker
